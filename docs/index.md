...
8 年以上にわたる Kotlin, Java による Android ネイティブアプリ開発や、Flutter, Unity によるクロスプラットフォーム開発など、様々なプロジェクトでの開発経験があります。

直近では、これまでの経験や現場での実績を買われ Android アプリ開発におけるテックリードを経験させていただきました。

特に私が強みとしているのは、レガシーコードのリファクタリングおよびリプレイスです。
